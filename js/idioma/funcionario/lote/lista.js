...
//homepage
let txtLista = document.getElementById("lista-lotes")
let txtFuncionario = document.getElementById("id-funcionario")
let txtListaPaquetes = document.getElementById("listar-paquetes")
let txtIDPaquete = document.getElementById("descripcion")
let txtIDEstante = document.getElementById("id-estado")
//footer
...
function traducirAIngles(){
    ...
    //homepage
    txtLista.innerHTML = "List lots"
    txtFuncionario.innerHTML = "Employee ID"
    txtListaPaquetes.innerHTML = "List packages"
    txtIDPaquete.innerHTML = "Description"
    txtIDEstante.innerHTML = "State ID"
    //footer
...
function traducirAEspanol(){
    ...
    //homepage
    txtLista.innerHTML = "Lista lotes"
    txtFuncionario.innerHTML = "ID Funcionario"
    txtListaPaquetes.innerHTML = "Listar paquetes"
    txtIDPaquete.innerHTML = "Descripcion"
    txtIDEstante.innerHTML = "ID Estado"
    //footer
