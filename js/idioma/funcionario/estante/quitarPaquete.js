...
//homepage
let txtLista = document.getElementById("quitar-paquete")
let txtFuncionario = document.getElementById("id-paquete")
...
function traducirAIngles(){
    ...
    //homepage
    txtLista.innerHTML = "Remove Package - Shelf"
    txtFuncionario.innerHTML = "Package ID"
...
function traducirAEspanol(){
    ...
    //homepage
    txtLista.innerHTML = "Quitar Paquete - Estante"
    txtFuncionario.innerHTML = "ID Paquete"
